<?php
	...
	if(!($_SERVER['HTTPS'])){
		header('Location: https://45.79.10.14/mercury.php');
	}//endif
...
<html>
    <head>
		...
		<style>
			...
			body {
				background:url("images/background/mercury_surface.jpg") no-repeat center center fixed;
    ...
    <body>
		...
		<div id="dialog">
			<div class="center">
				<div id="contentBox">
					<p>Welcome to the planet Mercury!<br>What would you like to do?</p>
					<br>
				</div>
